...
BOARD_MESA3D_VULKAN_DRIVERS := amd intel intel_hasvk virtio swrast nouveau gfxstream
BOARD_MESA3D_GALLIUM_VA := enabled
BOARD_MESA3D_VIDEO_CODECS := h264dec h265dec vc1dec av1dec
BOARD_MESA3D_MESON_ARGS := -Dallow-kcmp=enabled -Damdgpu-virtio=true -Dintel-virtio-experimental=true 
